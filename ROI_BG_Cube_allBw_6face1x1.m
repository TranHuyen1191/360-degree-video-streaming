...
fname = sprintf('Log%sROI_BG_Cube_log_%.0fface%.0fx%.0f_vbr.txt',bracket,No_face,tile_hori_num,tile_ver_num);
fout = fopen(fname,'w');
...
for i = 1:1:1 %% Original 1:1:11
    ...
    for angle = 0:15:0  %% Original 0:15:350
        ...
        [S_t,T,sel_BR] = F_ROI_BG_Cube(angle,Fh, Fv, vp_W,vp_H, face_W, face_H, phi,theta,No_face,tile_hori_num,tile_ver_num,No_ver,Bw,BR,deltaBR,PSNR,MSE,deltaMSE,LB_tile_W,LB_tile_H,HB_tile_W,HB_tile_H);
